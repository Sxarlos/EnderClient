...
const UA = 'ender-client/0.1.2 (ender-client)'
...
const INJECTED_SERVERS = [
  { name: "Hype's ATM 10 Server",     ip: 'atm10.minecraft.sxarlos-mc.org' },
  { name: "US - Hype's ATM 10 Server", ip: 'us.minecraft.sxarlos-mc.org' },
]
